...
<html lang="en">
<head>
    <title><spring:message code="showAllEntrants.title"/></title>
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <c:if test="${not empty entrants}">
            <div class="w3-container">
                <h3 style="margin: 30px; text-align: center"><spring:message code="showAllEntrants.allEntrants"/></h3>
                <c:forEach items="${entrants}" var="entrant">
                    <div class="w3-card-4" style="width: 70%">
                        <header class="w3-container w3-light-grey">
                            <h3><spring:message
                                    code="showAllEntrants.entrantName"/> ${entrant.firstName} ${entrant.lastName}</h3>
                        </header>
                        <div class="w3-container">
                            ...
                            <h3><spring:message code="showAllEntrants.age"/> ${entrant.age}</h3>
                            <br>
                            <h3><spring:message code="showAllEntrants.school"/> ${entrant.schoolName}</h3>
                            <br>
                            <h3><spring:message code="showAllEntrants.score"/> ${entrant.score}</h3>
                            <br>
                            <h3><spring:message code="showAllEntrants.faculty"/> ${entrant.faculty.name}</h3>
                        </div>
                        <a href="/statement/${entrant.id}" class="w3-button w3-block w3-dark-grey"> + <spring:message
                                code="showAllEntrants.addEntrantToTheStatement"/></a>
                    </div>
                    <br>
                    <br>
                </c:forEach>
